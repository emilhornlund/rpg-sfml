...
- **THEN** the build copies `overworld-terrain-tileset.png`, `assets/output/classifications/overworld-terrain-tileset-classification.json`, and `player-walking-spritesheet.png` from the repository-root asset tree
