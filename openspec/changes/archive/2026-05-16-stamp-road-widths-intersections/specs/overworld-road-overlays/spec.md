...
- **THEN** the published road occupancy can form branches, loops, destination-connected approaches, explicit width changes, readable bends, and structural intersections in addition to straight segments
