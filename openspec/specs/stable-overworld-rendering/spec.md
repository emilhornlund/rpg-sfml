...
Define stable overworld rendering requirements so movement remains responsive while camera presentation stays pixel-stable across zoom levels and frame pacing uses a single consistent strategy.
